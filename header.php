...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$gobusiness_description = get_bloginfo( 'description', 'display' );
			if ( $gobusiness_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $gobusiness_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->

		<nav id="site-navigation" class="main-navigation">
			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'gobusiness' ); ?></button>
			<?php
			wp_nav_menu(
				array(
